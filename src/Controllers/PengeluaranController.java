...
public class PengeluaranController implements Controller {
    ...
    public PengeluaranController(JTable table, JDialog form) {
        this.table = table;
        this.form = form;
    }
    ...
    public void tampilData() {
        try {
            ...
            ResultSet data = DB.query("SELECT nama,total_pengeluaran,keterangan,tanggal_pengeluaran FROM pengeluaran join users on  pengeluaran.id_user =users.id order by pengeluaran.id desc");
            int no = 1;
